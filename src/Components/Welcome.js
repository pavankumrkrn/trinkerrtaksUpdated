...
const Welcome = () => {
    return (
        <div className="welcome">
            ...
            <div className="mb-5">
                <p>Thanks for signing-up, in this app you will be provided 5 images. You can rate them by swiping left or right. Swipe right if you like them and left if you don't.</p>
